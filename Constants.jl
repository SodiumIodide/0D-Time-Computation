...
global const num_t = convert(Int64, 1e2)
global const delta_t = (t_max - t_init) / num_t  # s
global const chord_1 = 5.0 / sol  # s
global const chord_2 = 1.0 / sol  # s
...
global const num_divs = convert(Int64, 1e6)
global const max_iterations = convert(Int64, 2e1)
